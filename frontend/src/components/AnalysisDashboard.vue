...
onMounted(()=>{ window.addEventListener('show-planning-comparison',handleComparison); window.addEventListener('show-gis-charts',handleStandard); window.addEventListener('show-advanced-analysis',handleAdvanced); window.addEventListener('planning-scenario-changed',handleScenarioChanged); window.addEventListener('show-analysis-provenance',handleProvenance); });
onUnmounted(()=>{ window.removeEventListener('show-planning-comparison',handleComparison); window.removeEventListener('show-gis-charts',handleStandard); window.removeEventListener('show-advanced-analysis',handleAdvanced); window.removeEventListener('planning-scenario-changed',handleScenarioChanged); window.removeEventListener('show-analysis-provenance',handleProvenance); });
</script>
