...
/**
 * 生产鉴权链路（app.auth.enabled=true）：完整 JWT + RBAC。
 * 本地竞赛免登录模式见 {@link SecurityConfig}（app.auth.enabled=false，默认）。
 */
@Configuration
@EnableWebSecurity
...
public class SecuredSecurityConfig {
    ...
    public SecuredSecurityConfig(AuthProperties properties, ObjectMapper objectMapper,
    ...
    @Bean
    public AuthenticationManager securedAuthenticationManager(AuthenticationConfiguration configuration) throws Exception {
        return configuration.getAuthenticationManager();
    }

    @Bean
    public CorsConfigurationSource securedCorsConfigurationSource() {
    ...
    public SecurityFilterChain securedFilterChain(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .cors(cors -> cors.configurationSource(securedCorsConfigurationSource()))
